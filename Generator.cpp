...
Generator::Generator() : typ_sygnalu(TypSygnalu::PROSTOKATNY), wartosc_poczatkowa(0), wartosc_zmiany(1), czas_zmiany(10), wypelnienie(0.5), czas_aktywacji(1.0) {}

Generator::Generator(TypSygnalu typ, double poczatkowa, double zmiana, double czas_zmiany, double wyp, double t_akt)
    : typ_sygnalu(typ), wartosc_poczatkowa(poczatkowa), wartosc_zmiany(zmiana), czas_zmiany(czas_zmiany), wypelnienie(wyp), czas_aktywacji(t_akt) {}
